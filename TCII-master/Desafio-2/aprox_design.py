...
tipo_de_filtro='Pasa_Bajo'
#tipo_de_filtro='Pasa_Alto'
#tipo_de_filtro='Pasa_Banda'
...
ideal_filter=[alfa_max,alfa_min,omega_p,omega_s,tipo_de_filtro,aprox_name,omega_d,max_pc_delay]
